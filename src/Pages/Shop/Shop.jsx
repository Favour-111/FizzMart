...
import ProdSkelenton from "../../components/Skelenton/ProdSkelenton";
...
const Shop = ({ page }) => {
  const { categories, product, ProdLoader, categoryLoader } =
  ...
  }, [page, inStock, minPrice, maxPrice, rating, product]);
  ...
  const sortedProducts = useMemo(() => {
    ...
    switch (sortBy) {
      case "price-high":
        ...
        break;
      case "price-low":
        arr.sort((a, b) => Number(a.oldPrice) - Number(b.oldPrice));
        break;
      case "rating":
  ...
  const categoryImage = categories.find((itm) => {
    if (itm.name == page) {
      return itm;
    }
  });
